<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <!-- [스프링 폼태그 라이브러리]
    	스프링 프레임워크의 JSP 기술 중에 form taglib가 있다.
    	form 태그라이브러리를 사용하면 HTML 폼에 
    	컨트롤러에서 보낸 데이터를 편리하게 바인딩할 수 있다. -->
...
<body>
	...
	<!-- [modelAttribute (속성)]
		폼에 있는 요소들이 값을 채우기 위해서 컨트롤러의 모델에
		저장해놓은 객체를 찾을 때 쓰는 이름이다.
		컨드롤러에서 저장한 형태 model.addAttribute("member2", member) -->
